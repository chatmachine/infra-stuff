...
public class diff_platform_24hr_1minavg{
    GetYesterdayDate date = new GetYesterdayDate();
    //static File dir = new File("/home/sdhingra/data_automation/"+"20111014"+"_cpu");
    static File dir = new File("/home/sdhingra/"+GetYesterdayDate.GetDate()+"-24hravg");
  ...
  public static int getIndex(int perc, int count){
    ...
    private static void printmax(String[] data) {
      ...
      String file6=dir.toString()+"/MBWR_metrics";
      String file7=dir.toString()+"/TOT_metrics";
      String file8=dir.toString()+"/MBWW_metrics";
      String lastdate=GetYesterdayDate.GetDate();
       BufferedWriter out =null,out7=null,out2=null,out3=null,out4=null,out5=null,out6=null,out8=null;
       String[] tokens={"",""};
       String line;
       String hostname="";
       String[] plat_role;
